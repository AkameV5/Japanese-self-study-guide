...
public class HiraganaExerciseFinishActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hiragana_exercise_finish);
        ...
        btnBackToList.setOnClickListener(v -> {
            Intent intent = new Intent(
                    HiraganaExerciseFinishActivity.this,
